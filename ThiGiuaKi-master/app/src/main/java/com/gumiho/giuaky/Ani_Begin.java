...
public class Ani_Begin extends AwesomeSplash {
    @Override
    public void initSplash(ConfigSplash configSplash) {
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.store); //or any other drawable
        ...
        //Customize Title
        configSplash.setTitleSplash("Manager Store"); //change your app name here
    ...
    public void animationsFinished() {
        ...
        Intent intent = new Intent(Ani_Begin.this,MainActivity.class);
